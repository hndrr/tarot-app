...
const cardVideos: { [key: number]: CardVideo } = {
  ...
  2: {
    path: "magician",
    files: ["Wan_00002.mp4", "Wan_00004.mp4", "Wan_00005.mp4"],
  },
  3: {
    path: "high-priestess",
  ...
  16: {
    path: "devil",
    files: ["Wan_00032.mp4", "Wan_00054.mp4", "Wan_00048.mp4"],
  },
  17: {
    path: "tower",
    files: ["Wan_00032.mp4", "Wan_00054.mp4", "Wan_00051.mp4"],
  },
  18: {
    path: "star",
    files: ["Wan_00020.mp4", "Wan_00021.mp4", "Wan_00022.mp4"],
  },
  19: {
    path: "moon",
